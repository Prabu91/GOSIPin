...
<div class="container mx-auto p-8 bg-white shadow-md rounded-lg">
	<div class="flex items-center justify-between mb-6">
		...
		<div class="flex items-center">
			...
			<a href="{{ route('classification.create') }}" class="mx-2 bg-btn hover:bg-btnh text-txtd px-4 py-2 rounded">Tambah Data</a>
			<a href="{{ route('classification.importClassificationView') }}" class="bg-green-600 hover:bg-green-500 text-txtd px-4 py-2 rounded">Import Klasifikasi</a>
		</div>
	</div>
