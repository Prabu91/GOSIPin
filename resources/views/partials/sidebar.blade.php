...
<div class="h-full px-3 py-4 overflow-y-auto bg-sidebar items-center">
	...
	<ul class="space-y-2 font-medium mt-12 mx-auto">
		...
		<li>
			<a href="{{ route('users.index') }}" class="flex p-2 text-txtl rounded-lg dark:text-txtd hover:bg-gray-100 dark:hover:bg-gray-700 group">
		...
		<li>
			<a href="{{ route('classificationCode.index') }}" class="flex p-2 text-txtl rounded-lg dark:text-txtd hover:bg-gray-100 dark:hover:bg-gray-700 group">
	...
	<ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
		<li>
			<a href="{{ route('classification.index') }}" class="flex p-2 text-txtl rounded-lg dark:text-txtd hover:bg-gray-100 dark:hover:bg-gray-700 group">
		...
		<li>
			<a href="{{ route('classification.active') }}" class="flex p-2 text-txtl rounded-lg dark:text-txtd hover:bg-gray-100 dark:hover:bg-gray-700 group">
		...
		<li>
			<a href="{{ route('classification.inactive') }}" class="flex p-2 text-txtl rounded-lg dark:text-txtd hover:bg-gray-100 dark:hover:bg-gray-700 group">
		...
		<li>
			<a href="#" class="flex p-2 text-txtl rounded-lg dark:text-txtd hover:bg-gray-100 dark:hover:bg-gray-700 group">
